...
import com.zigaai.authorization.security.processor.usernamepassword.SysUsernamePasswordToken;
...
public class DaoMultiAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public DaoMultiAuthenticationProvider(StrategyFactory<SysUserType, MultiAuthenticationUserDetailsService> userDetailsServiceStrategy) {
        this(PasswordEncoderFactories.createDelegatingPasswordEncoder(), userDetailsServiceStrategy);
    }
     ...
     * @since 6.0.3
     */
    public DaoMultiAuthenticationProvider(PasswordEncoder passwordEncoder, StrategyFactory<SysUserType, MultiAuthenticationUserDetailsService> userDetailsServiceStrategy) {
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
        ...
        log.info("自定义校验方法: class={}", DaoMultiAuthenticationProvider.class);
