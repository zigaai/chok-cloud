...
public class BaseExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseData<Void> handleServiceException(BizIllegalArgumentException e) {
        log.debug("请求参数错误: ", e);
    ...
    // public ResponseData<Void> handleCryptoException(CryptoException e) {
    //     log.error(e.getMessage());
    //     return ResponseData.fail(e.getMessage(), null);
    // }


    // @ExceptionHandler(value = ExpiredJwtException.class)
    // @ResponseStatus(HttpStatus.UNAUTHORIZED)
    // public ResponseData<Void> expiredJwtExceptionHandler() {
    //     return ResponseData.unauthorized("登录已过期", null);
    // }
    //
    // @ExceptionHandler(value = InvalidTokenException.class)
    // @ResponseStatus(HttpStatus.UNAUTHORIZED)
    // public ResponseData<Void> handleInvalidTokenException(InvalidTokenException e) {
    //     return ResponseData.badRequest(e.getMessage(), null);
    // }
